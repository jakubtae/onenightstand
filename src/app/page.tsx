...
export default function Home() {
  return (
    <div className="font-montserrat flex flex-col items-center min-h-screen p-2 pt-8 gap-2 sm:p-20 bg-gray-100 border border-gray-300 w-full rounded-t-4xl mt-20">
